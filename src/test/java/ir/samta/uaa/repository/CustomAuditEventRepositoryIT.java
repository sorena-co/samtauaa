package ir.samta.uaa.repository;

import ir.samta.uaa.SamtauaaApp;
import ir.samta.uaa.config.Constants;
import ir.samta.uaa.config.audit.AuditEventConverter;
import ir.samta.uaa.domain.PersistentAuditEvent;
...
import static ir.samta.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
